...
A diferencia de $T_{\text{manual}}$, $C_{\text{hora}}$ y $N$ --que dependen de cada agencia y siguen siendo ilustrativos--, el tiempo que tarda el propio sistema en generar un borrador ya no es una estimación: sobre las 14~conversaciones reales que completaron un flyer (Capítulo~5), la latencia mediana es de 166~s (2,8~minutos), con un percentil~99 de 22~minutos. Esto indica que la hora asumida en $T_{\text{asistida}}$ corresponde casi por completo al tiempo de revisión humana, no a una espera del sistema.

El modelo anterior tampoco descuenta el coste de operar el sistema. Sobre las mismas 14~conversaciones, el coste medio real de generar un flyer completo es de 0,128~\$ (Capítulo~5; coste facturado en dólares por los proveedores de modelos de lenguaje, frente al ahorro laboral expresado en euros), lo que permite calcular un ahorro neto:
\[
\text{Ahorro económico neto (€/mes)} = \text{Ahorro económico bruto} - N \times \text{Coste medio por flyer}
\]
Con $N=25$, el coste operativo mensual asciende a apenas 3,2~\$ (25 × 0,128~\$), frente a un ahorro bruto de 1.875~€/mes: incluso asumiendo paridad aproximada entre ambas divisas para esta estimación, y con un volumen de propuestas conservador, el coste de ejecutar el sistema resulta prácticamente despreciable frente al ahorro laboral.
