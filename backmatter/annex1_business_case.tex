...
Con los valores ilustrativos de la Tabla \ref{tab:roi-supuestos}, esto supondría liberar 75 horas comerciales al mes (25 propuestas × 3 horas ahorradas), equivalentes a unos 1.875 €/mes (22.500 €/año) en tiempo comercial recuperado para tareas de mayor valor, como la atención al cliente o el cierre de ventas, en lugar de la búsqueda y redacción manual.

Al tratarse de servicios cloud de pago por uso (Capítulo 3, Selección Tecnológica) y no de una infraestructura con inversión inicial elevada, el coste de operar el sistema crece con el volumen real de propuestas generadas, en lugar de exigir un desembolso fijo por adelantado. Esto es lo que permite hablar de un retorno prácticamente inmediato: desde el primer mes de uso con un volumen de propuestas moderado, el ahorro de horas comerciales liberadas ya supera el coste variable de ejecutar el sistema, sin necesidad de amortizar una inversión previa en servidores o licencias.
